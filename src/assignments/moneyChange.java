...
public class moneyChange {
	public static void main(String[] args){
        ...
        int ammountPayed = scan.nextInt();

        int changeDue = ammountPayed - price;

        int amt = (int)changeDue;

        System.out.println("Return"+ amt+ "Rupees");
        
        int count, r2000=0, r500=0, r100=0, r50=0, r20=0, r10=0, r5=0, r2=0, r1=0;
